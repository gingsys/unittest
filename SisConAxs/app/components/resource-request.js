...
import { AccessTypeValue } from './resources/resource-accesstype.js'
...
export class Request extends Entity {
    ...
    constructor() {
        ...
        this.FileAttachedString = "";
        this.AttentionTicket = null;
        this.OracleUser = null;
        this.OracleMenu = null;

        this.RequestToNumDoc = "";

        this.FlagIsApprover = 0;
        this.ResourceParamValue = "";
    ...
    setRequestBy(people) {
        ...
        this.RequestByDepartment = people.PeopleDepartmentName || '';
        this.RequestByPosition = people.PeopleAttribute3 || ''; // <-- People Position;
    }
    ...
    setRequestTo(people) {
        ...
        this.RequestToNumDoc = people.PeopleDocNum;
        ...
        this.RequestToPosition = people.PeopleAttribute3 || ''; // <-- People Position;
    }
}
...
export class RequestResource extends ResourceBase {
    ...
    generateDetailFromPeople(peopleID, requestType, companyID) {
        const headers = {
            'X-Auth-Token': this.constructor.session.sessionToken || {}
        }
        ...
        return new Promise(function(resolve, reject = () => {}) {
            RequestResource.$get(`/api/AccessRequest/HaveAccess/?PeopleID=${peopleID}&RequestType=${requestType}`, undefined, {
                    ...
                    RequestResource.$get(`/api/AccessRequest/Details/?PeopleID=${peopleID}&RequestType=${requestType}&CompanyID=${companyID}`, undefined, {
                            headers
                        }).then(data => {
                            console
                            resolve({
    ...
    downloadFile(filename, requestnumber) {
        return RequestResource.$get(`/api/AccessRequest/download/?FileName=${filename}&RequestNumber=${requestnumber}`, undefined, {
            headers: {
                'X-Auth-Token': this.constructor.session.sessionToken || {}
            }
        });
