...
import './widgets/ui-widget-shorcuts.js';
import './widgets/ui-widget-request-forapproval.js';
...
export class HomeComponent extends Component {
    ...
    get $template() {
      ...
      <h4>Bienvenido a la <span class="text-warning">Interfaz Control de Accesos y Registro Único de Solicitudes</span> del Grupo</h4>
      <div class="widgets">
          <widget-shorcuts id="widgetShorcut"></widget-shorcuts>
          <!-- Card package -->
          <div class="card-columns">
            <widget-request-forapproval id="widgetRequestForApprove"></widget-request-forapproval>
          </div>
          <!-- Card package -->
      </div>
      <div class="text-center">
        <div class="text-center"> 
          Powered By 
          <img src="content/images/logo-poweredA.png" height="30" style="padding-left: 1rem;">
        </div>
      </div>`;
    }
...
customElements.define('application-home', HomeComponent);
