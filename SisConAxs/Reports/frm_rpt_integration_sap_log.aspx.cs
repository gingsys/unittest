...
{
    public partial class frm_rpt_integration_sap_log : System.Web.UI.Page
    {
        ...
        {
            string nameReport = "rpt_integration_sap_log";
        ...
        {
            if (ValidateDates(dpTypeStart.Value, dpTypeEnd.Value))
            {
