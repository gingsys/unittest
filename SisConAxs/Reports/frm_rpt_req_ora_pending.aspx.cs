...
{
    public partial class frm_rpt_req_ora_pending : System.Web.UI.Page
    {
        ...
        {
            string nameReport = "rpt_req_ora_auditoria";
        ...
        private void CargarReporte()
        {
            if (ValidarFechas(dpi.Value, dpf.Value))
            {
                ...
                par = new ReportParameter("pCOMPANY_ID", "0");
                this.ReportViewer01.ServerReport.SetParameters(new ReportParameter[] { par });

                par = new ReportParameter("pUSER_ID"," ");
                this.ReportViewer01.ServerReport.SetParameters(new ReportParameter[] { par });
