<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_rpt_req_ora_pending.aspx.cs" Inherits="SisConAxs.Reports.frm_rpt_req_ora_pending" %>
...
<head runat="server">
    ...
    <title>Reporte Consolidado de Solicitudes ORACLE - Auditoria</title>
                ...
                <div class="panel panel-default">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <h5 class="panel-title" title="Contraer"><i class="fas fa-chart-bar"></i>Reporte Consolidado de Solicitudes ORACLE - Auditoria <i id="icon" class="fas fa-chevron-up" <%--style="float: right;"--%>></i></h5>
                        </div>
                    </a>
