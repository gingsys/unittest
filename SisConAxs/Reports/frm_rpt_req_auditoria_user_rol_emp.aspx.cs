...
{
    public partial class frm_rpt_req_auditoria_user_rol_emp : System.Web.UI.Page
    {
        ...
        {
            string nameReport = "rpt_req_auditoria_user_rol_emp";
        ...
        private void CargarReporte()
        {
            if (ValidarFechas(dpi.Value, dpf.Value))
            {
                ...
                par = new ReportParameter("FechaInicio", fecha[0]);
                this.ReportViewer01.ServerReport.SetParameters(new ReportParameter[] { par });

                par = new ReportParameter("FechaFin", fecha[1]);
                this.ReportViewer01.ServerReport.SetParameters(new ReportParameter[] { par });

                par = new ReportParameter("Usuario", txtUsuario.Text.Trim() == "" ? null : txtUsuario.Text.Trim());
                this.ReportViewer01.ServerReport.SetParameters(new ReportParameter[] { par });
