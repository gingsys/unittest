<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_rpt_ejecuciones_sincronizacion_ora_solicitudes.aspx.cs" Inherits="SisConAxs.Reports.frm_rpt_ejecuciones_sincronizacion_ora_solicitudes" %>
...
<head runat="server">
    ...
    <title>Reporte Ejecuciones automáticas Oracle de solicitudes</title>
                ...
                <div class="panel panel-default">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <h5 class="panel-title" title="Contraer"><i class="fas fa-chart-bar"></i>Reporte Ejecuciones automáticas Oracle de las solicitudes <i id="icon" class="fas fa-chevron-up" <%--style="float: right;"--%>></i></h5>
                        </div>
                    </a>
