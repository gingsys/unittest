<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_rpt_auditoria_usuarios.aspx.cs" Inherits="SisConAxs.Reports.frm_rpt_auditoria_usuarios" %>
...
<head runat="server">
    ...
    <title> Reporte de usuarios para auditoria</title>
                ...
                <div class="panel panel-default">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <h5 class="panel-title" title="Contraer"><i class="fas fa-chart-bar"></i> Reporte de usuarios para auditoria <i id="icon" class="fas fa-chevron-up" <%--style="float: right;"--%>></i></h5>
                        </div>
                    </a>
                    <div id="collapseOne" class="panel-collapse show" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            ...
                            <div class="form-group row pl-2 mb-1">
                                ...
                                <label class="col-sm-2 col-form-label">Estado Actual Usuario:</label>
                                <div class="col-sm-2">
